    ...
    <xsl:template match="/">
        <html>
           ...
           <div id="Tables">  <!--<h2>Table 1: Yes or No Questions</h2>  -->
               ...
               Scroll down for more survey questions and response data, and a view of the original 19th-century survey results. Thanks to Alex Mielnicki for the SVG design!
               </span>
